              ...
              <div class="form-group col-sm-12">
               ...
               %>
				...
				<%
					...
					out.print(userbeans.getStatus());
					//userbeans.getStatus()==0
					%>
					<div class="card" style="margin:10px; border-color: blue;">
			            ...
			            <div class="card-body">
						<form action="CommentSection3ByJudges" method="post">
							<div class="form-group">
			                    ...
			                    <div class="col-sm-12 " >
			                          ...
			                          <div class="form-control" style="height: auto;">
									    ...
									    <button type="button" class="btnrating btn btn-default btn-lg <%if(userbeans.getStatus()>0){%>Disabled<% } %>" data-attr="2" id="rating-star-2">
									        <i class="fa fa-star" aria-hidden="true"></i>
									    </button>
									    <button type="button" class="btnrating btn btn-default btn-lg <%if(userbeans.getStatus()>0){%>Disabled<% } %>" data-attr="3" id="rating-star-3">
									        <i class="fa fa-star" aria-hidden="true"></i>
									    </button>
									    <button type="button" class="btnrating btn btn-default btn-lg <%if(userbeans.getStatus()>0){%>Disabled<% } %>" data-attr="4" id="rating-star-4">
									        <i class="fa fa-star" aria-hidden="true"></i>
									    </button>
									    <button type="button" class="btnrating btn btn-default btn-lg <%if(userbeans.getStatus()>0){%>Disabled<% } %>" data-attr="5" id="rating-star-5">
									        <i class="fa fa-star" aria-hidden="true"></i>
									    </button>
									   </div>
			                    </div>
			                ...
			                <div class="form-group">
			                    ...
			                    <div class="col-sm-12">
			                    	<textarea rows="" cols="" name="comment" class="form-control"  <%if(userbeans.getStatus()>0){%>readonly="readonly"<% } %>><%=userRatingBean.getComment() %></textarea>
...
jQuery(document).ready(function($){
	...
	ratingfnc();
	 function ratingfnc() {
		var selected_value=<%=userRatingBean.getRating()%>
		for (i = 1; i <= selected_value; ++i) {
			$("#rating-star-"+i).toggleClass('btn-warning');
			$("#rating-star-"+i).toggleClass('btn-default');
			}
